        ...
        <div class="row">
            <div class="column small-12 medium-6 large-7 small-text-small">
                <header class="footer-header">
                    <strong class="h4">Rychlé odkazy</strong>
                </header>
                ...
                <ul class="nav nav-footer">
                    ...
                    <li>
                        <a href="/sluzby/hubnuti-celulitida">Hubnutí a celulitida</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/sluzby/lymfodrenaz-infrasauna">Lymfodrenáže s&nbsp;infrasaunou</a>
                    </li>
                    <li>
            ...
            <div class="column small-12 medium-6 large-5 small-text-small">
                ...
                <header class="footer-header">
                    <strong class="h4">Kontaktní informace</strong>
                </header>
